package step06_chatting.chat_4;
...
public class GUIChatClient extends JFrame implements ActionListener, Runnable{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(ob==btn_send || ob==txt_input){
			String txt=txt_input.getText();   // "전송"버튼  or   txt_input에서 엔터를 친 경우
			...
			pw.flush();
			txt_input.setText("");
			txt_input.requestFocus();          //커서를 txt_input으로 이동
